...
module.exports = {
    ...
    async run(bot, message, args) {
        ...
        if (message.user.id === user.id) return message.reply("Tu ne peux pas te kick toi meme !")
        if ((await message.guild.fetchOwner()).id === user.id) return message.reply("Tu ne peux pas kick le fondateur du serveur")
