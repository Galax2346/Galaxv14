...
module.exports = {
    ...
    name: "leaderboard",
    description: "Classement de l'expérience du serveur",
    ...
    async run(bot, message, args, db) {
        ...
        db.query(`SELECT * FROM xp WHERE guild = '${message.guildId}'`, async(err, req) => {
            ...
            const Leaderboard = await new Canvas.Leaderboard()
                ...
                .setBackground("https://www.cea.fr/comprendre/PublishingImages/vignettes/l-essentiel-sur/vignette-galaxies.jpg")
                .setColorFont("#FFFFFF")
